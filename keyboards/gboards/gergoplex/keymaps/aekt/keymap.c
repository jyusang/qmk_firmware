...
#define CM_DEL LT(_COMMON, KC_DEL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_gergoplex(
        ...
        LS_Z    , KC_X    , KC_C    , KC_V    , KC_B    , KC_N    , KC_M    , KC_COMM , KC_DOT  , RS_SLSH ,
                            LG_BSPC , LC_ESC  , KC_SPC  , LS_TAB  , SM_ENT  , CM_DEL
    ),
    [_SYMBOL] = LAYOUT_gergoplex(
        KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    ,
        KC_EXLM , KC_AT   , KC_HASH , KC_DLR  , KC_PERC , KC_CIRC , KC_AMPR , KC_ASTR , KC_GRV  , KC_COLN ,
        KC_TILD , KC_PIPE , KC_BSLS , KC_UNDS , KC_MINS , KC_PLUS , KC_EQL  , KC_LABK , KC_RABK , KC_QUES ,
                            POINT   , FUNCT   , _______ , _______ , _______ , _______
    ),
    [_COMMON] = LAYOUT_gergoplex(
        _______ , KC_LCBR , KC_RCBR , _______ , _______ , KC_MPRV , KC_VOLD , KC_VOLU , KC_MNXT , KC_MUTE ,
        _______ , KC_LPRN , KC_RPRN , _______ , _______ , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_QUOT ,
        KC_CAPS , KC_LBRC , KC_RBRC , _______ , _______ , KC_HOME , KC_PGDN , KC_PGUP , KC_END  , KC_DQUO ,
                            POINT   , FUNCT   , _______ , _______ , _______ , _______
    ),
    ...
    [_FUNCT] = LAYOUT_gergoplex(
        ...
        KC_F9   , KC_F10  , KC_F11  , KC_F12  , _______ , _______ , MU_OFF  , MU_ON   , _______ , KC_LSFT ,
                            _______ , _______ , _______ , KC_RALT , KC_RCTL , KC_RGUI
    ),
    // clang-format on
};
