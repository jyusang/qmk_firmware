...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    FNCTN   , KC_LCTL , KC_LALT , KC_LGUI , SFT_ESC , KC_SPC            , SYM_ENT , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT
),
[_COLEMAK] = LAYOUT_planck_mit(
    KC_TAB  , KC_Q    , KC_W    , KC_F    , KC_P    , KC_G    , KC_J    , KC_L    , KC_U    , KC_Y    , KC_SCLN , KC_BSPC ,
    KC_LCTL , KC_A    , KC_R    , KC_S    , KC_T    , KC_D    , KC_H    , KC_N    , KC_E    , KC_I    , KC_O    , KC_QUOT ,
    KC_NO   , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , KC_K    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_BSLS ,
    FNCTN   , KC_LCTL , KC_LALT , KC_LGUI , SFT_ESC , KC_SPC            , SYM_ENT , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT
),
...
[_FNCTN] = LAYOUT_planck_mit(
    ...
    ADJUST  , _______ , _______ , _______ , _______ , _______ , KC_HOME , KC_PGUP , KC_PGDN , KC_END  , _______ , _______ ,
